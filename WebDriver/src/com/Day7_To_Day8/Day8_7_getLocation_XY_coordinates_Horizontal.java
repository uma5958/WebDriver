...
public class Day8_7_getLocation_XY_coordinates_Horizontal {
	...
	public static void main(String[] args) throws Exception {
		...
		if (lp.getY()==lp1.getY()) {
			System.out.println("Both Text Boxes Are Aligned Horizontally");
		} else {
			System.out.println("Both Text Boxes are Not Aligned Horizotally");
		}
